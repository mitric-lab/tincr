...
impl<'a> SuperSystem<'a> {
    pub fn exciton_coupling<'b>(&self, lhs: &'b BasisState<'b>, rhs: &'b BasisState<'b>) -> f64  {
        match (lhs, rhs) {
    ...
    pub fn le_le<'b>(&self, i: &'b LocallyExcited<'b>, j: &'b LocallyExcited<'b>) -> f64 {
        ...
        let exchange: f64 = match type_pair {
            ...
            PairType::Pair => {
                ...
                let n_atoms: usize = i.monomer.atoms.len() + j.monomer.atoms.len();
    ...
    // on monomer I.
    pub fn ct_ct<'b>(&self, state_1: &'b ChargeTransfer<'b>, state_2: &'b ChargeTransfer<'b>) -> f64 {
    ...
    pub fn le_ct<'b>(&self, i: &'b LocallyExcited<'b>, j: &'b ChargeTransfer<'b>) -> f64 {
        self.le_ct_1e(i, j) + self.le_ct_2e(i, j)
    }

    pub fn le_ct_1e<'b>(&self, i: &'b LocallyExcited<'b>, j: &'b ChargeTransfer<'b>) -> f64 {
        // < LE I | H | CT K_j -> I_b >
    ...
    /// < LE I | H | CT J_j -> K_b >
    pub fn le_ct_2e<'b>(&self, i: &'b LocallyExcited<'b>, j: &'b ChargeTransfer<'b>) -> f64 {
        // Check if the pair of monomers I and J is close to each other or not: S_IJ != 0 ?
    ...
    pub fn ct_le<'b>(&self, i: &'b ChargeTransfer<'b>, j: &'b LocallyExcited<'b>) -> f64 {
        self.le_ct(j, i)
    }
}
