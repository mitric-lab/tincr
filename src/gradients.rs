...
fn f_lr_new(v: ArrayView2<f64>,
    ...
    // let mut grad_s:Array3<f64> = grad_s.to_owned();
    // grad_s.swap_axes(0,1);
    // grad_s.swap_axes(1,2);
    //
    // let mut g1_lr_ao:Array3<f64> = g1_lr_ao.to_owned();
    // g1_lr_ao.swap_axes(0,1);
    // g1_lr_ao.swap_axes(1,2);
    //
    // println!("Grad S dim {:?}",grad_s.dim());
    // println!("G1 dim {:?}",g1_lr_ao.dim());
