use crate::parametrization::skf_handler::{process_slako_line, SkfHandler};
...
pub struct PseudoAtomHomegrown {
    pub(crate) z: u8,
    pub hubbard_u: f64,
    pub(crate) n_elec: u8,
...
impl PseudoAtomHomegrown {
    pub fn free_atom(element: &str) -> Self {
    ...
    pub fn confined_atom(element: &str) -> Self {
        let path_prefix: String = get_path_prefix();
        let filename: String = format!(
