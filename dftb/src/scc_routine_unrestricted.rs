...
use core::::logging::*;
use core::::{fermi_occupation, get_repulsive_energy, construct_h1, construct_h_magnetization, density_matrix, enable_level_shifting, get_electronic_energy, get_electronic_energy_unrestricted, lc_exact_exchange, get_frontier_orbitals};
...
impl<'a> UnrestrictedSCC for System<'a> {
    ...
    fn prepare_unrestricted_scc(&mut self) {
        ...
        self.data.set_if_unset_dq_alpha(Array1::zeros(self.atoms.len()));
        self.data.set_if_unset_dq_beta(Array1::zeros(self.atoms.len()));
    ...
    fn run_unrestricted_scc(&mut self) -> Result<f64, SCCError> {
        ...
        let mut broyden_mixer_alpha: BroydenMixer = BroydenMixer::new(self.atoms.len());
        let mut broyden_mixer_beta: BroydenMixer = BroydenMixer::new(self.atoms.len());
